...
class StoreWorkRequest extends FormRequest
{
    ...
    {
        // You can add your authorization logic here, for now returning true to allow the request
        return true;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'employer_id' => 'exists:users,id', // Employee ID must exist in users table
